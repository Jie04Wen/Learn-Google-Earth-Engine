...
- `代码/01_基础语法与几何.js`：print、几何与矢量可视化。
- `代码/02_四大核心数据结构.js`：Geometry、Feature、FeatureCollection、Image、ImageCollection。
- `代码/03_筛选预处理与指数.js`：筛选、去云、镶嵌、裁剪、五类指数与统计。
- `代码/04_时序合成图表与导出.js`：月度/年度合成、图表和三类导出。
- `代码/05_完整项目_森林NDVI时序变化_2018_2026.js`：完整森林 NDVI 长时序项目。

## 快速开始

1. 完成 Google Cloud 项目和 Earth Engine 访问配置。
2. 打开 <https://code.earthengine.google.com/>。
3. 先运行 `01_基础语法与几何.js`，再按编号学习。
